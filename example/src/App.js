        ...
        <main className="main">
          <div className="container">
            ...
            <div className="layout">
              <div className="cell">
                <Shape inset={`right top`} padding={`16`}>
              ...
              <div className="cell">
                <Shape inset={`right bottom`} padding={`16`}>
                  <div className="margin">
                    <h3>Irregular</h3>
              ...
              <div className="cell">
                <Shape inset={`left bottom`} padding={`16`}>
                    <div className="margin">
                    <h3>Shapes</h3>
          ...
          <Shape insetBottom={`right`} insetTop={`right`} padding={`16 0`}>
            <div className="container">
              <h2>Installation</h2>
              <p>Using npm.</p>
